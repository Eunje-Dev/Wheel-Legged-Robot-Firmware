...
/* USER CODE BEGIN PV */
uint32_t test_mx_pos[4] = { 2048, 2048, 2048, 2048 }; // MX-Series 목표 위치 배열 (ID 1~)
uint32_t dummy_knee[4] = { 2048, 2048, 2048, 2048 }; // 더미 데이터 (패킷 구조 유지용, 사용 안 함)
uint16_t test_ax_spd[4] = { 0, 0, 0, 0 };             // AX-Series 속도 제어용

int toggle_state = 0; // 동작 상태 토글 플래그 (0: 초기 위치, 1: 이동 위치)
/* USER CODE END PV */
